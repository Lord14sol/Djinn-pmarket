        ...
        <div className="relative min-h-[calc(100vh-80px)] w-full overflow-hidden bg-black text-white selection:bg-purple-500/30">
            ...
            <main className="relative z-10 mx-auto flex max-w-7xl flex-col items-center justify-center px-4 py-20 text-center">
                ...
                <motion.div
                    ...
                    className="relative w-full max-w-lg overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-2xl"
                >
                        ...
                        <AnimatePresence mode="wait">
                            {loading ? (
                                ...
                                <motion.div key="full" className="py-6">
                                    ...
                                    <p className="text-sm text-gray-400">The gateway has closed. Watch for the next prophecy.</p>
                                </motion.div>
                            ) : (
